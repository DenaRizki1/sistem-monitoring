...
class _PagePermintaanIzinState extends State<PagePermintaanIzin> {
  ...
  final TextEditingController _izinTC = TextEditingController();

  late bool _serviceEnabled;

  TextEditingController _keteranganC = TextEditingController();

  FilePickerResult? resultFile;
  String dataFile = "", filePdfName = "", lokasi = "";
  bool fileImg = true;
  Map? _selectedJenisIzin;
  Position? _currentLocation;

  List items = [
    {'jenis': "Izin Sakit", 'index': 1},
    {'jenis': "Izin Dengan Keterangan", 'index': 2},
    {'jenis': "Izin Lainnya", 'index': 3},
  ];
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: SizedBox(
            ...
            child: Text(
              pageIzin! ? "Permintaan Izin" : "Permintaan Cuti",
                    ...
                    !pageIzin!
                              ...
                              showDateRangePicker(
                                ...
                                (value) {
                                  if (value != null) {
                                    ...
                                    _izinTC.text = (int.parse(dateRange.duration.toString().replaceAll(":00:00.000000", "")) / 24 + 1).toStringAsFixed(0) + " Hari";
                                  }
                                },
                              );
                            },
                        ...
                        : TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: parseDateInd(DateTime.now().toString(), "EEEE, dd MMMM yyyy"),
                              ...
                              Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton(
                                    borderRadius: BorderRadius.circular(12),
                                    hint: _selectedJenisIzin == null ? Text("Pilih Jenis Izin") : Text(_selectedJenisIzin?['jenis'].toString() ?? ""),
                                    items: items.map(
                                      (val) {
