...
class PageTryoutJasmaniSiswaDetail extends StatefulWidget {
  final String hashSiswa;
  final String namaSiswa;
  final String kdTryout;
  final String kdLokasiAbsen;

  const PageTryoutJasmaniSiswaDetail({
    Key? key,
    required this.hashSiswa,
    required this.namaSiswa,
    required this.kdTryout,
    required this.kdLokasiAbsen,
  }) : super(key: key);

  @override
  State<PageTryoutJasmaniSiswaDetail> createState() => _PageTryoutJasmaniSiswaDetailState();
}

class _PageTryoutJasmaniSiswaDetailState extends State<PageTryoutJasmaniSiswaDetail> {
  ...
  Future<void> getAbsenSiswa() async {
    ...
    final response = await ApiConnect.instance.request(
      ...
      url: EndPoint.daftarSiswaDetailJasmani,
      params: {
  ...
  Future<void> verifAbsenSiswa(String kdAbsen, String statusVerif, String keterangan) async {
    ...
    final response = await ApiConnect.instance.request(
      requestMethod: RequestMethod.post,
      url: EndPoint.verifAbsenSiswaJasmani,
      params: {
        'token_auth': pref.getString(TOKEN_AUTH) ?? "",
        'hash_user': pref.getString(HASH_USER) ?? "",
        'kd_absen': kdAbsen,
