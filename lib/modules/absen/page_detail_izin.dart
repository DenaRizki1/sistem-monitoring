...
class PageDetailIzin extends StatefulWidget {
  ...
  const PageDetailIzin({Key? key, required this.dataAbsen}) : super(key: key);
...
class _PageDetailIzinState extends State<PageDetailIzin> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(parseDateInd(_dataAbsen['tgl_izin'], "dd MMMM yyyy")),
      body: Stack(
        children: [
          SizedBox(
                              ...
                              children: [
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        _dataAbsen['ket_jenis_izin'].toString(),
                                      ...
                                      FxSpacing.height(4),
                                      Text(
                                        parseDateInd("${_dataAbsen['tgl_izin']} ${_dataAbsen['jam_izin']}", "dd MMMM yyyy  HH:mm WIB"),
                                        style: GoogleFonts.montserrat(
                                          color: Colors.black,
                                          fontSize: 12,
