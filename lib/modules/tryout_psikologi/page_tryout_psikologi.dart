...
import 'package:absentip/modules/tryout_psikologi/page_tryout_psikologi_detail.dart';
...
class PageTryoutPsikologi extends StatefulWidget {
  const PageTryoutPsikologi({Key? key}) : super(key: key);

  @override
  State<PageTryoutPsikologi> createState() => _PageTryoutPsikologiState();
}

class _PageTryoutPsikologiState extends State<PageTryoutPsikologi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget("Tryout Psikologi"),
      body: Stack(
        children: [
          SizedBox(
