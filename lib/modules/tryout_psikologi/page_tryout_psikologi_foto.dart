...
class PageTryoutPsikologiFoto extends StatefulWidget {
  final Map tryout;

  const PageTryoutPsikologiFoto({Key? key, required this.tryout}) : super(key: key);

  @override
  State<PageTryoutPsikologiFoto> createState() => _PageTryoutPsikologiFotoState();
}

class _PageTryoutPsikologiFotoState extends State<PageTryoutPsikologiFoto> {
  Map _tryout = {};
  String _filePath = "";
  String _title = "";
  ...
  Future<void> simpanAbsen(String idLokasiAbsen) async {
    ...
    final response = await ApiConnect.instance.uploadFile(
      EndPoint.simpanAbsenTryoutPsikologi,
      "foto",
      resultPath,
      {
