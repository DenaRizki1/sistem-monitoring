...
import 'package:absentip/modules/tryout_psikologi/page_tryout_psikologi_siswa_detail.dart';
...
class PageTryoutPsikologiSiswa extends StatefulWidget {
  final String kdJadwal;

  const PageTryoutPsikologiSiswa({Key? key, required this.kdJadwal}) : super(key: key);

  @override
  State<PageTryoutPsikologiSiswa> createState() => _PageTryoutPsikologiSiswaState();
}

class _PageTryoutPsikologiSiswaState extends State<PageTryoutPsikologiSiswa> {
  ...
  Future<void> getSiswaAbsen() async {
    ...
    final response = await ApiConnect.instance.request(
      ...
      url: EndPoint.daftarSiswaPsikologi,
      params: {
