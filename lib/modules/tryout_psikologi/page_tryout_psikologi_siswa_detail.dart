...
class PageTryoutPsikologiSiswaDetail extends StatefulWidget {
  final String hashSiswa;
  final String namaSiswa;
  final String kdJaldwal;

  const PageTryoutPsikologiSiswaDetail({
    Key? key,
    required this.hashSiswa,
    required this.namaSiswa,
    required this.kdJaldwal,
  }) : super(key: key);

  @override
  State<PageTryoutPsikologiSiswaDetail> createState() => _PageTryoutPsikologiSiswaDetailState();
}

class _PageTryoutPsikologiSiswaDetailState extends State<PageTryoutPsikologiSiswaDetail> {
  ...
  Future<void> verifAbsenSiswa(String kdAbsen, String statusVerif, String keterangan) async {
    ...
    final response = await ApiConnect.instance.request(
      requestMethod: RequestMethod.post,
      url: EndPoint.verifAbsenSiswaPsikologi,
      params: {
        'token_auth': pref.getString(TOKEN_AUTH) ?? "",
        'hash_user': pref.getString(HASH_USER) ?? "",
        'kd_absen': kdAbsen,
