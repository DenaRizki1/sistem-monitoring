...
import 'package:absentip/modules/aktivitas/page_tambah_aktivitas.dart';
...
class PageAktivitas extends StatefulWidget {
  const PageAktivitas({Key? key}) : super(key: key);

  @override
  State<PageAktivitas> createState() => _PageAktivitasState();
}

class _PageAktivitasState extends State<PageAktivitas> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget("Laporan Aktivitas", action: [
        IconButton(
          onPressed: () {
            AppNavigator.instance.push(
              MaterialPageRoute(
                builder: (context) => const PageTambahAktivitas(),
              ),
            );
          },
          icon: Icon(
