...
import 'package:absentip/modules/tryout_akademik/page_tryout_akademik_siswa_detail.dart';
...
class PageTryoutAkademikSiswa extends StatefulWidget {
  final String kdTryout;

  const PageTryoutAkademikSiswa({Key? key, required this.kdTryout}) : super(key: key);

  @override
  State<PageTryoutAkademikSiswa> createState() => _PageTryoutAkademikSiswaState();
}

class _PageTryoutAkademikSiswaState extends State<PageTryoutAkademikSiswa> {
  ...
  Future<void> getSiswaAbsen() async {
    ...
    final response = await ApiConnect.instance.request(
      ...
      url: EndPoint.daftarSiswaAkademik,
      params: {
                        ...
                        child: InkWell(
                          onTap: () {
                            AppNavigator.instance.push(
                              MaterialPageRoute(
                                builder: (context) => PageTryoutAkademikSiswaDetail(
