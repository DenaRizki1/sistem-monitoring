...
class PageTryoutAkademikScan extends StatefulWidget {
  final Map tryout;
  const PageTryoutAkademikScan({Key? key, required this.tryout}) : super(key: key);

  @override
  State<PageTryoutAkademikScan> createState() => _PageTryoutAkademikScanState();
}

class _PageTryoutAkademikScanState extends State<PageTryoutAkademikScan> {
  Map _tryout = {};
