...
class _PageRekapIzinState extends State<PageRekapIzin> {
  ...
  getRekapIzin() async {
    ...
    log(dataIzin[0]['keterangan'].toString());
  }
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => PageDetailIzin(
                                    data: dataIzin[index],
                                    pageIzin: true,
                                  ),
                                ));
                                        ...
                                        children: [
                                          Flexible(
                                            child: Container(
                                              ...
                                              child: Center(
                                                child: TextMontserrat(
                                                  text: dataIzin[index]['ket_jenis_izin'].toString(),
                                                  fontSize: 11,
                                                ),
                                              ),
                                            ),
                                          ...
                                          Row(
                                            children: [
                                              dataIzin[index]['status_verifikasi'] == "1"
                                                  ? Icon(
                                                      MdiIcons.close,
                                                      color: Colors.red,
                                                    )
                                              ...
                                              TextMontserrat(
                                                text: dataIzin[index]['status_verifikasi'] == "1" ? "Belum Disetujui" : "Disetujui",
                                                fontSize: 14,
                                                bold: true,
                                                color: Colors.black,
                                              ),
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Expanded(
                                            flex: 3,
                                            child: TextMontserrat(
                                              text: parseDateInd(dataIzin[index]['tgl_izin'].toString(), "EEE dd MMMM yyyy"),
                                              fontSize: 14,
                                              color: Colors.black,
                                            ),
                                          ),
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Expanded(
                                            flex: 3,
                                            child: TextMontserrat(
                                              text: dataIzin[index]['keterangan'],
                                              fontSize: 14,
                                              color: Colors.black,
                                            ),
                                          )
